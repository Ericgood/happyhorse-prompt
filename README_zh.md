...
- 🏆 **AI 视频竞技场 #1** — Elo 1389（文生视频），Elo 1416（图生视频）
...
| 模型 | T2V Elo | I2V Elo | 备注 |
|:---|:---:|:---:|:---|
| **HappyHorse-1.0** | **1,389** | **1,416** | 开源，阿里 ATH |
| Seedance 2.0 (720p) | 1,274 | 1,358 | 字节跳动 |
| SkyReels V4 | 1,244 | 1,296 | Skywork AI |
| Kling 3.0 1080p Pro | 1,243 | — | 快影 |
| grok-imagine-video | 1,229 | 1,333 | xAI |

*更新于 2026年4月10日。来源：[Artificial Analysis Video Arena](https://artificialanalysis.ai/video/leaderboard/text-to-video)*
